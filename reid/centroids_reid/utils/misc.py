...
from reid.centroids_reid.callbacks import ModelCheckpointPeriodic
from reid.centroids_reid.datasets import init_dataset
from reid.centroids_reid.modelling.backbones.resnet_ibn_a import resnet50_ibn_a
