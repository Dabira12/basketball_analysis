...
from reid.centroids_reid.losses.center_loss import CenterLoss
from reid.centroids_reid.losses.triplet_loss import CrossEntropyLabelSmooth, TripletLoss
from reid.centroids_reid.modelling.baseline import Baseline
from reid.centroids_reid.solver import build_optimizer, build_scheduler
from reid.centroids_reid.utils.reid_metric import R1_mAP
...
class ModelBase(pl.LightningModule):
    def __init__(self, cfg=None, test_dataloader=None, **kwargs):
        ...
        # Instead of directly setting hparams, use save_hyperparameters
        self.save_hyperparameters(hparams)
        # Access hparams through self.hparams instead of setting directly
