...
from reid.centroids_reid.utils.misc import get_backbone

from reid.centroids_reid.modelling.backbones.resnet import BasicBlock, Bottleneck, ResNet
from reid.centroids_reid.modelling.backbones.resnet_ibn_a import resnet50_ibn_a, resnet101_ibn_a
