...
from reid.losses.center_loss import CenterLoss
from reid.losses.triplet_loss import CrossEntropyLabelSmooth, TripletLoss
from reid.modelling.baseline import Baseline
from reid.solver import build_optimizer, build_scheduler
